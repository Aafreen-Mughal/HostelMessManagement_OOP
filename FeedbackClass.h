...
void Feedback::input()
{
	...
	if (text == "excellent" || text == "great" || text == "fantastic" || text == "delicious" || text == "amazing"|| text == "tasty"|| text == "flavorful"|| text == "mouthwatering"|| text == "delectable"|| text == "scrumptious"|| text == "yummy"|| text == "savory"|| text == "outstanding"|| text == "impressive"|| text == "phenomenal"|| text == "topnotch"|| text == "fabulous"|| text == "perfect"|| text == "superb"|| text == "terrific")
	{
		cout << good_feedback[getRandomNumber()] << endl;
	}

	else if (text == "okay" || text == "decent" || text == "satisfactory" || text == "average" || text == "adequate"|| text == "decent"|| text == "good"|| text == "fine"|| text == "ok"|| text == "satisfactory"|| text == "acceptable"|| text == "fair"|| text == "passable"|| text == "average"|| text == "reasonable"|| text == "solid"|| text == "not bad"|| text == "notbad"|| text == "respectable")
	{
