...
public:
    ...
    label7:
    	...
    	cin >> edit;
     	int count=0,i;
	    ofstream f1("temp1.txt");
	    ofstream f2("temp2.txt");
	    ofstream f3("temp3.txt");
    	if(f1.is_open() && f2.is_open() && f3.is_open())
    	{
			  ...
			  for (int i = 0; i < length_breakfast; i++)
              {
                ...
                {
				  f1 << _breakfast[i] <<"\n" <<endl;
                  f2 << breakfast_quantity[i] << "\n"<<endl;
                  f3 << breakfast_price[i] << "\n"<<endl;
                }
              }
	           remove("breakfast.txt");
	           remove("break_quant.txt");
	           remove("Break_price.txt");
	           rename("temp1.txt","breakfast.txt");
	           rename("temp2.txt","break_quant.txt");
	           rename("temp3.txt","Break_price.txt");
	    }
	    else
     	{
     		cout <<"\nError"<<endl;
    	...
    	if(f1.is_open()&&f2.is_open()&&f3.is_open())
    	{
			  ...
			  for (int i = 0; i < length_lunch; i++)
              {
	           ...
	           remove("lunch.txt");
	           remove("lunch_quant.txt");
	           remove("lunch_price.txt");
	           rename("temp1.txt","lunch.txt");
	           rename("temp2.txt","lunch_quant.txt");
	           rename("temp3.txt","lunch_price.txt");
	       }
	    else
     	{
     		cout <<"\nError"<<endl;
    	...
    	if(f1.is_open()&&f2.is_open()&&f3.is_open())
    	{
			  ...
			  for (int i = 0; i < length_dinner; i++)
              {
                ...
                {
				  f1 << _dinner[i] << "\n"<<endl;
                  f2 << dinner_quantity[i] << "\n"<<endl;
                  f3 << dinner_price[i] << "\n"<<endl;
                }
              }
	           remove("dinner.txt");
	           remove("dinner_quant.txt");
	           remove("dinner_price.txt");
	           rename("temp1.txt","dinner.txt");
	           rename("temp2.txt","dinner_quant.txt");
	           rename("temp3.txt","dinner_price.txt");
	    }
	    else
     	{
     		cout <<"\nError"<<endl;
